...
const App = () => {
  ...
  const isValidDataSegment = (start, end) => {
    ...
    return checkNegative && checkEndGreaterStart && checkNull && checkInvalidNumber
  }

  const addData = () => {
    if (isValidDataSegment(parseInt(start), parseInt(end))) {
      const segment = {
    ...
    <>
      ...
      <div>
        ...
        <div className='form-submit'>
          ...
          <div className='notification' style={{display: noti}}>Input invalid</div>
        </div>
